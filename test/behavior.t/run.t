...
(* FIXME: This is a problem in all tests: The build artefacts aren't found.*)
  ...
  {"sample_id":12,"cmd":" ocamlmerlin server locate -look-for ml -position '3:12'  -filename test1.ml < test1.ml","responses":[{"class":"return","value":{"file":"stdlib.ml","pos":{"line":104,"col":9}},"notifications":[],"query_num":12}]}
  ...
  {"sample_id":9,"cmd":"ocamlmerlin server occurrences -identifier-at '3:12'  -filename test1.ml < test1.ml","responses":[{"class":"return","value":[{"start":{"line":3,"col":12},"end":{"line":3,"col":13},"stale":false}],"notifications":[],"query_num":9}]}
  ...
  {"sample_id":5,"cmd":" ocamlmerlin server locate -look-for ml -position '3:12'  -filename test.ml < test.ml","responses":[{"class":"return","value":{"file":"stdlib.ml","pos":{"line":104,"col":9}},"notifications":[],"query_num":5}]}
  ...
  {"sample_id":2,"cmd":"ocamlmerlin server occurrences -identifier-at '3:12'  -filename test.ml < test.ml","responses":[{"class":"return","value":[{"start":{"line":3,"col":12},"end":{"line":3,"col":13},"stale":false}],"notifications":[],"query_num":2}]}
